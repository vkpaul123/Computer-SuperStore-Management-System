 ...
 * @author hp-pc
 */
public class ReportCustomers extends javax.swing.JFrame {

    public NewMDIApplication mdiObj = null;
    
    /**
     * Creates new form ReportCustomers
     */
    public ReportCustomers()    {}
    public ReportCustomers(NewMDIApplication mdiObj) {
        initComponents();
        
        this.mdiObj = mdiObj;
    }
    
    public void fillFromCustomersTable()    {
        try {
    ...
    public void printCustomersTable()  {
        ...
        try {
            boolean complete = jTableCustomers.print(JTable.PrintMode.FIT_WIDTH, header, footer, true, null, true, null);
    ...
    private void initComponents() {
        ...
        setTitle("CSMS - Customers Report");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Icons/New Icons/IconsPNG/1458176516_Customer_Female_Dark.png"))); // NOI18N
        ...
        jLabel2.setText("CUSTOMERS REPORT");
        ...
        jTableCustomers.setEnabled(false);
        jTableCustomers.setFillsViewportHeight(true);
        jTableCustomers.setFocusable(false);
        jTableCustomers.setGridColor(new java.awt.Color(255, 255, 255));
        jTableCustomers.setIntercellSpacing(new java.awt.Dimension(20, 20));
        jTableCustomers.setName(""); // NOI18N
        jTableCustomers.setRequestFocusEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportCustomers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportCustomers().setVisible(true);
            }
        });
    }
