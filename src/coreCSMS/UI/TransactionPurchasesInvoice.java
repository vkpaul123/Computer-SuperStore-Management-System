 ...
 * @author hp-pc
 */
public class TransactionPurchasesInvoice extends javax.swing.JFrame  implements Printable {
     ...
     */
    public TransactionPurchasesInvoice()    {
        initComponents();
    }
    public TransactionPurchasesInvoice(NewMDIApplication mdiObj) {
        initComponents();
        this.mdiObj = mdiObj;
    }
    ...
    public void fillParticulars(String salesId)   {
        try {
            ...
            ResultSet rs = st.executeQuery("Select product_brand, product_model, purchased_quantity, product_price from Purchase_Orders where purchase_id=" + Integer.parseInt(salesId) + "");
    ...
    public void generateExistingInvoice(String salesID) {
        ...
        try {
            ...
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("select supplier_id, purchases_total_amount, purchases_date from Purchases_Billing where purchase_id=" + Integer.parseInt(salesID) + "");
            if(rs.next())   {
            ...
            rs = st.executeQuery("select supplier_name, supplier_phno from Suppliers where supplier_id=" + Integer.parseInt(custID) + "");
            if(rs.next())   {
    ...
    public void setOriginalInvoice(boolean x)   {
        if(x)
            jLabel3.setText("Supplier's Invoice (Original Copy)");
        else
            jLabel3.setText("Supplier's Invoice (Duplicate Copy)");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Supplier's Invoice");
        ...
        jLabel9.setText("Supplier Ph. No.:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransactionPurchasesInvoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TransactionPurchasesInvoice().setVisible(true);
            }
        });
    }
