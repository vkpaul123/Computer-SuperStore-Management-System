 ...
 * @author hp-pc
 */
public class ReportSalesBilling extends javax.swing.JFrame {
     ...
     */
    public ReportSalesBilling() {}
    public ReportSalesBilling(NewMDIApplication mdiObj) {
        initComponents();
        this.mdiObj = mdiObj;
    }
    ...
    public void printSalesBillingTable()  {
        MessageFormat header = new MessageFormat("SALES BILLING REPORT");    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportSalesBilling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportSalesBilling().setVisible(true);
            }
        });
    }
