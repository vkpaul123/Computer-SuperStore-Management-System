 ...
 * @author hp-pc
 */
public class ReportSuppliers extends javax.swing.JFrame {

    public NewMDIApplication mdiObj = null;
    
    /**
     * Creates new form ReportSuppliers
     */
    public ReportSuppliers()    {}
    public ReportSuppliers(NewMDIApplication mdiObj) {
        initComponents();
        this.mdiObj = mdiObj;
        
    }
    
    public void fillFromSuppliersTable()    {
        try {
    ...
    public void printSuppliersTable()  {
        MessageFormat header = new MessageFormat("SUPPLIERS REPORT");    
        MessageFormat footer = new MessageFormat("PAGE {0}");    
        
        try {
            boolean complete = jTableSuppliers.print(JTable.PrintMode.FIT_WIDTH, header, footer, true, null, true, null);
    ...
    private void initComponents() {
        ...
        setTitle("CSMS - Suppliers Report");
        ...
        jLabel2.setText("SUPPLIERS REPORT");
        ...
        jTableSuppliers.setEnabled(false);
        jTableSuppliers.setFillsViewportHeight(true);
        jTableSuppliers.setFocusable(false);
        jTableSuppliers.setGridColor(new java.awt.Color(255, 255, 255));
        jTableSuppliers.setIntercellSpacing(new java.awt.Dimension(20, 20));
        jTableSuppliers.setName(""); // NOI18N
        jTableSuppliers.setRequestFocusEnabled(false);
        jTableSuppliers.setRowHeight(30);
        jTableSuppliers.setRowSelectionAllowed(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportSuppliers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportSuppliers().setVisible(true);
            }
        });
    }
