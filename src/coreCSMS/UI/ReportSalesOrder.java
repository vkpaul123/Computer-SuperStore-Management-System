 ...
 * @author hp-pc
 */
public class ReportSalesOrder extends javax.swing.JFrame {

    public NewMDIApplication mdiObj = null;
    
    /**
     * Creates new form ReportSalesOrder
     */
    public ReportSalesOrder()   {}
    public ReportSalesOrder(NewMDIApplication mdiObj) {
        initComponents();
        this.mdiObj = mdiObj;
    }
    
    
    public void fillFromSalesOrdersTable()    {
        try {
            Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            Connection con = DriverManager.getConnection("jdbc:odbc:MyDSN_256");
                    
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("Select sales_id, product_id, product_brand, product_model, sold_quantity, product_price from Sales_Orders order by sales_id");
    ...
    public void printSalesOrdersTable()  {
        MessageFormat header = new MessageFormat("SALES ORDERS REPORT");    
        MessageFormat footer = new MessageFormat("PAGE {0}");    
        
        try {
            boolean complete = jTableSalesOrders.print(JTable.PrintMode.FIT_WIDTH, header, footer, true, null, true, null);
    ...
    private void initComponents() {
        ...
        setTitle("CSMS - Sales Order Report");
        ...
        jLabel2.setText("SALES ORDER REPORT");
        ...
        jTableSalesOrders.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SALES ID", "PRODUCT ID", "PRODUCT BRAND", "PRODUCT MODEL", "SOLD QUANTITY", "PRODUCT PRICE"
            }
        ) {
        ...
        jTableSalesOrders.setEnabled(false);
        jTableSalesOrders.setFillsViewportHeight(true);
        jTableSalesOrders.setFocusable(false);
        jTableSalesOrders.setGridColor(new java.awt.Color(255, 255, 255));
        jTableSalesOrders.setIntercellSpacing(new java.awt.Dimension(20, 20));
        jTableSalesOrders.setName(""); // NOI18N
        jTableSalesOrders.setRequestFocusEnabled(false);
        jTableSalesOrders.setRowHeight(30);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportSalesOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportSalesOrder().setVisible(true);
            }
        });
    }
