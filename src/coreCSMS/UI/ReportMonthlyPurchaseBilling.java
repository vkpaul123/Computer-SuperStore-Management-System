 ...
 * @author hp-pc
 */
public class ReportMonthlyPurchaseBilling extends javax.swing.JFrame {
     ...
     */
    public ReportMonthlyPurchaseBilling()  { initComponents();}
    public ReportMonthlyPurchaseBilling(NewMDIApplication mdiObj) {
        initComponents();
        this.mdiObj = mdiObj;
    }
    ...
    public void fillFromPurchaseBillingTable()    {
        try {
            ...
            ResultSet rs = st.executeQuery("Select * from Purchases_Billing where purchases_date like '%" + selectMonth() + "%'order by purchase_id");
    ...
    public void printPurchaseBillingTable()  {
        MessageFormat header = new MessageFormat("MONTHLY PURCHASE BILLING REPORT");    
        MessageFormat footer = new MessageFormat("TOTAL MONTHLY PURCHASES (RS.): " + totalMonthlySales() + " /-.        PAGE {0}");    
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Total Monthly Purchases (Rs.):");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportMonthlyPurchaseBilling.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportMonthlyPurchaseBilling().setVisible(true);
            }
        });
    }
