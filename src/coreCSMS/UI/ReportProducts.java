...
public class ReportProducts extends javax.swing.JFrame {
    ...
    public ReportProducts(NewMDIApplication mdiObj) {
        initComponents();
        this.mdiObj = mdiObj;
    }
    
    public void fillFromProductsTable()    {
        try {
                    Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
                    Connection con = DriverManager.getConnection("jdbc:odbc:MyDSN_256");
                    
                    Statement st = con.createStatement();
                    ResultSet rs = st.executeQuery("Select product_id, product_brand, product_model, product_category, product_quantity_in_stock, product_price from Products order by product_id");
    ...
    public void printProductsTable()  {
        MessageFormat header = new MessageFormat("PRODUCTS STOCK REPORT");    
    ...
    private void initComponents() {
        ...
        jLabel2.setText("PRODUCTS STOCK REPORT");
        ...
        jTableProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PRODUCT ID", "PRODUCT BRAND", "PRODUCT MODEL", "PRODUCT CATEGORY", "PRODUCT QUANTITY", "PRODUCT PRICE"
            }
        ) {
