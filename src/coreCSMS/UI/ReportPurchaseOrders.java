 ...
 * @author hp-pc
 */
public class ReportPurchaseOrders extends javax.swing.JFrame {

    public NewMDIApplication mdiObj = null;
    
    /**
     * Creates new form ReportPurchaseOrders
     */
    public ReportPurchaseOrders()   {}
    public ReportPurchaseOrders(NewMDIApplication mdiObj) {
        initComponents();
        this.mdiObj = mdiObj;
    }
    
    
    public void fillFromPurchaseOrdersTable()    {
        try {
            Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            Connection con = DriverManager.getConnection("jdbc:odbc:MyDSN_256");
                    
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("Select purchase_id, product_id, product_brand, product_model, purchased_quantity, product_price from Purchase_Orders order by purchase_id");
            ResultSetMetaData rsMeta = rs.getMetaData();
            rs.setFetchDirection(ResultSet.FETCH_FORWARD);
            int columnCount = rsMeta.getColumnCount();
            DefaultTableModel tableModel = (DefaultTableModel) jTablePurchaseOrders.getModel();
    ...
    public void printPurchaseOrdersTable()  {
        MessageFormat header = new MessageFormat("PURCHASES ORDERS REPORT");    
        MessageFormat footer = new MessageFormat("PAGE {0}");    
        
        try {
            boolean complete = jTablePurchaseOrders.print(JTable.PrintMode.FIT_WIDTH, header, footer, true, null, true, null);
    ...
    private void initComponents() {
        ...
        setTitle("CSMS - Purchase Order Report");
        ...
        jLabel2.setText("PURCHASE ORDER REPORT");
        ...
        jTablePurchaseOrders.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "PURCHASE ID", "PRODUCT ID", "PRODUCT BRAND", "PRODUCT MODEL", "PURCHASED QUANTITY", "PRODUCT PRICE"
            }
        ) {
        ...
        jTablePurchaseOrders.setEnabled(false);
        jTablePurchaseOrders.setFillsViewportHeight(true);
        jTablePurchaseOrders.setFocusable(false);
        jTablePurchaseOrders.setGridColor(new java.awt.Color(255, 255, 255));
        jTablePurchaseOrders.setIntercellSpacing(new java.awt.Dimension(20, 20));
        jTablePurchaseOrders.setName(""); // NOI18N
        jTablePurchaseOrders.setRequestFocusEnabled(false);
        jTablePurchaseOrders.setRowHeight(30);
        jTablePurchaseOrders.setRowSelectionAllowed(false);
        jScrollPane1.setViewportView(jTablePurchaseOrders);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReportPurchaseOrders.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReportPurchaseOrders().setVisible(true);
            }
        });
    }
